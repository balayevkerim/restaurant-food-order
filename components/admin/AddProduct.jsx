  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const uploadRes = await axios.post(
        "https://api.cloudinary.com/v1_1/dtxosaqsf/image/upload",
        data
      );
          ...
          <div className="relative z-50 md:w-[600px] w-[370px]  bg-white border-2 p-10 rounded-3xl">
            ...
            <div className="flex flex-col text-sm mt-6">
              <label className="flex gap-2 items-center">
                <input
                  ...
                  className="hidden"
                />
                <button className="cursor-pointer border-none rounded-[45px] transition-all text-white py-[0.5rem] px-7 hover:bg-[#e69c00]  !bg-blue-600 pointer-events-none">
                  Choose an Image
                </button>
                {imageSrc && (
                  <div>
            ...
            <div className="flex flex-col text-sm mt-4 w-full">
              ...
              <div className="flex  gap-6 w-full md:flex-nowrap flex-wrap">
                ...
                />
                <button
                  className="cursor-pointer border-none bg-primary rounded-[45px] transition-all text-white py-[0.5rem] px-7 hover:bg-[#e69c00] ml-auto"
                  onClick={handleExtra}
                >
                  Add
                </button>
            ...
            <div className="flex justify-end">
              <button
                className=" flex items-center gap-2 cursor-pointer border-none rounded-[45px] transition-all text-white py-[0.5rem] px-7 hover:bg-[#e69c00] bg-success"
